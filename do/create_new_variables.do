...
*/
foreach i of varlist gpa_cat mat1320 mat1720 mat1330 mat1730 mat1300 mat1700 eng1100 eng1112 fra1528 fra1538 fra1710 phi1101 phi1501 eng_highest eng_lowest math_highest math_lowest fre_highest fre_lowest phil_highest phil_lowest any_highest any_lowest {
...
foreach i of varlist mat1320 mat1720 mat1330 mat1730 mat1300 mat1700 eng1100 eng1112 fra1528 fra1538 fra1710 phi1101 phi1501 eng_highest eng_lowest math_highest math_lowest fre_highest fre_lowest phil_highest phil_lowest any_highest any_lowest {
	local var_lbl : variable label `i'
	generate `i'_rel1 = .
...
foreach i in _fall _y1 {
	...
	egen fre_highest`i' = rowmin(fra1528`i' fra1538`i' fra1710`i')
	label values fre_highest`i' grade_codes
	tabulate fre_highest`i', missing

	egen phil_highest`i' = rowmin(phi1101`i' phi1501`i')
	label values phil_highest`i' grade_codes
	tabulate phil_highest`i', missing
	...
	tabulate phil_lowest`i', missing
	...
	foreach j of varlist mat1320`i' mat1720`i' mat1330`i' mat1730`i' mat1300`i' mat1700`i' eng1100`i' eng1112`i' fra1528`i' fra1538`i' fra1710`i' phi1101`i' phi1501`i' eng_highest`i' eng_lowest`i' math_highest`i' math_lowest`i' fre_highest`i' fre_lowest`i' phil_highest`i' phil_lowest`i' any_highest`i' any_lowest`i' {
