// uoirp_descriptive5.do
set more off

/*
  19JUL2011: File created based on uoirp_descriptive1.do

  This file will run the descriptive stats by gender.
...
*/
local dofilename "uoirp_descriptive5"
...
local cat_vars "`cat_vars' math_lo_y1 eng_lo_y1 fre_lo_y1 phil_lo_y1 any_lo_y1"
...
local cat_vars "`cat_vars' math_lo_fall eng_lo_fall fre_lo_fall phil_lo_fall any_lo_fall"
