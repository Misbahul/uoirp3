...
local cat_vars "`cat_vars' english_highest_y1 french_highest_y1 philosophy_highest_y1 any_highest_y1"
...
local cat_vars "`cat_vars' english_highest_fall french_highest_fall philosophy_highest_fall any_highest_fall"
