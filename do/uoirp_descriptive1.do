...
local cat_vars "`cat_vars' math_lowest_y1 english_lowest_y1 french_lowest_y1 philosophy_lowest_y1 any_lowest_y1"
...
local cat_vars "`cat_vars' math_lowest_fall english_lowest_fall french_lowest_fall philosophy_lowest_fall any_lowest_fall"
...
local cat_vars "`cat_vars' math_highest_rel1 math_lowest_rel1 english_highest_rel1 english_lowest_rel1 french_highest_rel1 french_lowest_rel1 phil_highest_rel1 philosophy_lowest_rel1 any_highest_rel1 any_lowest_rel1"
local cat_vars "`cat_vars' math_highest_rel2 math_lowest_rel2 english_highest_rel2 english_lowest_rel2 french_highest_rel2 french_lowest_rel2 phil_highest_rel2 philosophy_lowest_rel2 any_highest_rel2 any_lowest_rel2"
local cat_vars "`cat_vars' math_highest_rel3 math_lowest_rel3 english_highest_rel3 english_lowest_rel3 french_highest_rel3 french_lowest_rel3 phil_highest_rel3 philosophy_lowest_rel3 any_highest_rel3 any_lowest_rel3"
